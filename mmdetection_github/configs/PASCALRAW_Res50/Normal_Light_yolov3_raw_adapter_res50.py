...
model = dict(
    ...
    backbone={'type': 'RAW_ResNet', 'depth': 50, 'num_stages': 4, 'out_indices': (1, 2, 3), 'light_mode': {'type': 'normal'}, 'w_lut': False, 'lut_dim': 32, 'k_size': 3, 'fea_c_s': [256, 512, 1024], 'ada_c_s': [24, 48, 96], 'mid_c_s': [64, 64, 128], 'merge_ratio': 1.0, 'frozen_stages': -1, 'norm_cfg': {'type': 'BN', 'requires_grad': True}, 'norm_eval': True, 'style': 'pytorch', 'init_cfg': {'type': 'Pretrained', 'checkpoint': 'torchvision://resnet50'}},
    neck=dict(
        type='YOLOV3Neck',
        num_scales=3,
