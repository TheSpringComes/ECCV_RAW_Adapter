...
model = dict(
    ...
    backbone={'type': 'RAW_ResNet', 'depth': 18, 'num_stages': 4, 'out_indices': (1, 2, 3), 'light_mode': {'type': 'normal'}, 'lut_dim': 32, 'k_size': 3, 'fea_c_s': [64, 128, 256], 'ada_c_s': [12, 24, 48], 'mid_c_s': [32, 32, 64], 'merge_ratio': 1.0, 'frozen_stages': -1, 'norm_cfg': {'type': 'BN', 'requires_grad': True}, 'norm_eval': True, 'style': 'pytorch', 'init_cfg': {'type': 'Pretrained', 'checkpoint': 'torchvision://resnet18'}},
    neck=dict(
        type='YOLOV3Neck',
        num_scales=3,
